...
VALUES
    ('cmt-01', 'Research Advisory Committee', 'Standing', 'Advise on research direction, review project proposals, and evaluate annual research output across all divisions.', 'S001', 'S002', 'Active', '2024-04-01', '2024-04-01T00:00:00Z'),
    ('cmt-02', 'Equipment Procurement Review', 'AdHoc', 'Evaluate major equipment purchase proposals (>10 lakhs), assess technical specifications, and recommend vendor selection.', 'S040', 'T004', 'Active', '2025-08-15', '2025-08-15T00:00:00Z'),
    ('cmt-03', 'PhD Progress Review Committee', 'Review', 'Review PhD student progress biannually, evaluate thesis submissions, and recommend synopsis approvals.', 'S025', 'S026', 'Active', '2023-01-10', '2023-01-10T00:00:00Z'),
    ('cmt-04', 'Industry Collaboration Advisory Board', 'Advisory', 'Identify industry partnership opportunities, review MoUs, and guide technology transfer initiatives.', 'S012', 'S014', 'Active', '2025-01-01', '2025-01-01T00:00:00Z'),
    ('cmt-05', 'Infrastructure & Safety Committee', 'Standing', 'Oversee lab infrastructure maintenance, safety compliance audits, and building facility upgrades.', 'S037', 'T002', 'Active', '2023-06-01', '2023-06-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('cmm-01', 'cmt-01', 'S001', 'Member'),
    ('cmm-02', 'cmt-01', 'S002', 'Member'),
    ('cmm-03', 'cmt-01', 'S012', 'Member'),
    ('cmm-04', 'cmt-01', 'S040', 'Member'),
    ('cmm-05', 'cmt-01', 'S045', 'Member'),
    ('cmm-06', 'cmt-01', 'H001', 'Invitee'),
    ('cmm-07', 'cmt-02', 'S040', 'Member'),
    ('cmm-08', 'cmt-02', 'T004', 'Member'),
    ('cmm-09', 'cmt-02', 'T001', 'Member'),
    ('cmm-10', 'cmt-02', 'H002', 'Member'),
    ('cmm-11', 'cmt-03', 'S025', 'Member'),
    ('cmm-12', 'cmt-03', 'S026', 'Member'),
    ('cmm-13', 'cmt-03', 'S003', 'Member'),
    ('cmm-14', 'cmt-03', 'S013', 'Member'),
    ('cmm-15', 'cmt-04', 'S012', 'Member'),
    ('cmm-16', 'cmt-04', 'S014', 'Member'),
    ('cmm-17', 'cmt-04', 'H002', 'Member'),
    ('cmm-18', 'cmt-04', 'S045', 'Invitee'),
    ('cmm-19', 'cmt-05', 'S037', 'Member'),
    ('cmm-20', 'cmt-05', 'T002', 'Member'),
    ('cmm-21', 'cmt-05', 'T003', 'Member'),
    ('cmm-22', 'cmt-05', 'H001', 'Invitee')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('mtg-01', 'cmt-01', '2026-04-10', 'CSIR-AMPRI Conference Hall', 'Q1 Research Review Meeting', 'Reviewed 8 project proposals. Approved 5 for funding in FY 2026-27.', 'Completed', '2026-03-15T00:00:00Z'),
    ('mtg-02', 'cmt-01', '2026-05-07', 'Virtual — MS Teams', 'Mid-Year Research Assessment', '', 'Scheduled', '2026-04-20T00:00:00Z'),
    ('mtg-03', 'cmt-01', '2026-06-15', 'CSIR-AMPRI Auditorium', 'Annual Research Output Evaluation', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-04', 'cmt-02', '2026-04-05', 'Admin Board Room', 'XRD Replacement Procurement', 'Finalized specs for Rigaku SmartLab XRD. Recommended sole-source procurement due to compatibility.', 'Completed', '2026-03-20T00:00:00Z'),
    ('mtg-05', 'cmt-02', '2026-05-10', 'Admin Board Room', 'SEM-EDS Upgrade Evaluation', '', 'Scheduled', '2026-04-25T00:00:00Z'),
    ('mtg-06', 'cmt-02', '2026-06-20', 'Admin Board Room', 'Q2 Equipment Budget Allocation', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-07', 'cmt-03', '2026-03-20', 'Seminar Hall', 'PhD Synopsis Review — Spring 2026', 'Reviewed 3 synopses. Approved all with minor revisions. Student presentations assessed by panel.', 'Completed', '2026-03-01T00:00:00Z'),
    ('mtg-08', 'cmt-03', '2026-05-15', 'Seminar Hall', 'PhD Progress Presentations', '', 'Scheduled', '2026-04-15T00:00:00Z'),
    ('mtg-09', 'cmt-03', '2026-07-01', 'Seminar Hall', 'Thesis Defense Evaluations', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-10', 'cmt-04', '2026-02-15', 'CSIR-AMPRI Guest House', 'Industry MoU Review — Q4 FY2025', 'Reviewed 3 MoUs with NTPC, Tata Steel, and DRDO. Recommended signing all three.', 'Completed', '2026-02-01T00:00:00Z'),
    ('mtg-11', 'cmt-04', '2026-05-20', 'CSIR-AMPRI Guest House', 'Technology Transfer Pipeline Review', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-12', 'cmt-04', '2026-06-10', 'Virtual — Google Meet', 'New Partner Identification Workshop', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-13', 'cmt-05', '2026-03-01', 'Admin Board Room', 'Annual Safety Audit Review', 'Reviewed 12 non-conformances from 2025 audit. 10 resolved, 2 pending — assigned action items.', 'Completed', '2026-02-15T00:00:00Z'),
    ('mtg-14', 'cmt-05', '2026-05-25', 'Admin Board Room', 'Lab Infrastructure Upgrade Planning', '', 'Scheduled', '2026-05-01T00:00:00Z'),
    ('mtg-15', 'cmt-05', '2026-07-15', 'Admin Board Room', 'Fire Safety Drill & Equipment Audit', '', 'Scheduled', '2026-06-01T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('agi-01', 'mtg-01', 1, 'Review of Q4 FY2025 research output', 'S001', 'Discussed'),
    ('agi-02', 'mtg-01', 2, 'New project proposal: Nano-refractories for steel industry', 'S002', 'Discussed'),
    ('agi-03', 'mtg-01', 3, 'Budget allocation for FY 2026-27 research programs', 'S012', 'Discussed'),
    ('agi-04', 'mtg-01', 4, 'Any other business — patent filing status update', 'S045', 'Deferred'),
    ('agi-05', 'mtg-02', 1, 'Mid-year project status reports from all divisions', 'S001', 'Pending'),
    ('agi-06', 'mtg-02', 2, 'PhD candidate recruitment plan 2027', 'S014', 'Pending'),
    ('agi-07', 'mtg-04', 1, 'Technical specification review for new XRD system', 'S040', 'Discussed'),
    ('agi-08', 'mtg-04', 2, 'Vendor comparison: Rigaku vs. Bruker vs. PANalytical', 'T004', 'Discussed'),
    ('agi-09', 'mtg-07', 1, 'Synopsis review: Arjun Nair (Refractory Ceramics)', 'S025', 'Discussed'),
    ('agi-10', 'mtg-07', 2, 'Synopsis review: Divya Kapoor (Energy Materials)', 'S025', 'Discussed'),
    ('agi-11', 'mtg-13', 1, 'Non-conformance closure status review', 'S037', 'Discussed'),
    ('agi-12', 'mtg-13', 2, 'Emergency shower and eyewash station inspection report', 'T003', 'Discussed')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('act-01', 'mtg-01', 'meeting', 'Submit revised budget proposal for Nano-refractory project', 'S002', '2026-05-20', 'Pending', NULL, 'Include consumables cost escalation'),
    ('act-02', 'mtg-01', 'meeting', 'Distribute Q1 review minutes to all division heads', 'H001', '2026-05-01', 'Pending', NULL, ''),
    ('act-03', 'mtg-04', 'meeting', 'Obtain three vendor quotations for XRD procurement', 'T004', '2026-05-30', 'Pending', NULL, 'Rigaku quote already received'),
    ('act-04', NULL, 'manual', 'Prepare annual equipment calibration schedule for all labs', 'T001', '2026-06-15', 'Pending', NULL, 'Coordinate with division heads for access windows'),
    ('act-05', 'mtg-13', 'meeting', 'Replace faulty fire extinguishers in Labs A, C, and D', 'T002', '2026-05-15', 'Pending', NULL, '2 CO2 and 1 Dry Powder type needed'),
    ('act-06', 'mtg-01', 'meeting', 'Compile patent filing tracker for FY 2025-26', 'S045', '2026-05-10', 'InProgress', NULL, 'Awaiting legal department confirmation on 2 filings'),
    ('act-07', 'mtg-07', 'meeting', 'Schedule thesis defense for Arjun Nair', 'S026', '2026-05-25', 'InProgress', NULL, 'Waiting for external examiner confirmation'),
    ('act-08', NULL, 'manual', 'Update chemical inventory database for all labs', 'T003', '2026-06-01', 'InProgress', NULL, 'BMS and NST labs completed, ARC pending'),
    ('act-09', 'mtg-13', 'meeting', 'Install additional fume hoods in Lab-C', 'S037', '2026-07-01', 'InProgress', NULL, 'Civil work in progress, electrical connection pending'),
    ('act-10', 'mtg-10', 'meeting', 'Draft MoU template for industry-sponsored PhD programs', 'S012', '2026-05-30', 'InProgress', NULL, 'Legal review awaited'),
    ('act-11', 'mtg-01', 'meeting', 'Archive closed projects documentation for CSIR audit', 'H001', '2026-04-15', 'Completed', '2026-04-10T00:00:00Z', 'All 5 closed projects documented'),
    ('act-12', 'mtg-04', 'meeting', 'Decommission non-operational HT furnace (E006)', 'T001', '2026-04-30', 'Completed', '2026-04-28T00:00:00Z', 'Repair order placed, furnace isolated'),
    ('act-13', 'mtg-07', 'meeting', 'Update PhD student handbook with new submission guidelines', 'S026', '2026-03-31', 'Completed', '2026-03-28T00:00:00Z', 'PDF shared with all supervisors'),
    ('act-14', 'mtg-10', 'meeting', 'Send signed MoUs to CSIR-HQ for ratification', 'H001', '2026-03-01', 'Completed', '2026-02-28T00:00:00Z', 'All 3 MoUs acknowledged by HQ'),
    ('act-15', 'mtg-13', 'meeting', 'Complete electrical safety audit for all buildings', 'T002', '2026-03-15', 'Completed', '2026-03-12T00:00:00Z', 'Minor issues noted in Building D, reported to maintenance')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('doc-01', 'mtg-01', 'Q1_Research_Meeting_Agenda.pdf', 'committee-docs/mtg-01/agenda.pdf', '2026-03-15T00:00:00Z'),
    ('doc-02', 'mtg-01', 'Q1_Research_Review_Minutes.pdf', 'committee-docs/mtg-01/minutes.pdf', '2026-04-12T00:00:00Z'),
    ('doc-03', 'mtg-04', 'XRD_Technical_Specs.pdf', 'committee-docs/mtg-04/specs.pdf', '2026-03-20T00:00:00Z'),
    ('doc-04', 'mtg-07', 'PhD_Synopsis_Review_Minutes.pdf', 'committee-docs/mtg-07/minutes.pdf', '2026-03-25T00:00:00Z'),
    ('doc-05', 'mtg-13', 'Safety_Audit_Report_2025.pdf', 'committee-docs/mtg-13/audit.pdf', '2026-02-15T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('tkt-01', 'AMPRI-260501-001', 'AC not working in Lab-A103', 'Infrastructure', 'High', 'The air conditioning unit in Lab-A103 has stopped cooling. Ambient temperature is affecting XRD instrument calibration.', 'T001', 'S001', 'InProgress', '2026-05-01T09:00:00Z', '2026-05-02T14:00:00Z', NULL),
    ('tkt-02', 'AMPRI-260502-001', 'Water leakage in Building D corridor', 'Infrastructure', 'Medium', 'Water seepage observed near the SEM lab entrance during rain. Needs immediate inspection to prevent equipment damage.', 'T002', 'S001', 'Open', '2026-05-02T11:00:00Z', '2026-05-02T11:00:00Z', NULL),
    ('tkt-03', 'AMPRI-260503-001', 'Generator backup test overdue', 'Infrastructure', 'Low', 'Quarterly generator backup test for Building A was scheduled in April but not conducted. Request rescheduling.', 'H001', 'S037', 'Open', '2026-05-03T08:00:00Z', '2026-05-03T08:00:00Z', NULL),
    ('tkt-04', 'AMPRI-260430-001', 'TGA-001 calibration error', 'EquipmentIT', 'High', 'Thermogravimetric Analyzer showing drift in baseline readings. Calibration failed 3 consecutive attempts. Research work halted.', 'T003', 'S012', 'InProgress', '2026-04-30T15:00:00Z', '2026-05-01T10:00:00Z', NULL),
    ('tkt-05', 'AMPRI-260504-001', 'Network printer not accessible from Lab-B', 'EquipmentIT', 'Medium', 'The shared network printer (HP LaserJet M507) is offline for all users in Lab-B wing. Reboot did not resolve.', 'S013', 'S012', 'Open', '2026-05-04T09:30:00Z', '2026-05-04T09:30:00Z', NULL),
    ('tkt-06', 'AMPRI-260415-001', 'UPS battery replacement for Lab-A servers', 'EquipmentIT', 'Critical', 'UPS batteries in server room showing end-of-life warning. Risk of data loss during power fluctuations. Needs urgent replacement.', 'S002', 'S037', 'Resolved', '2026-04-15T10:00:00Z', '2026-04-28T16:00:00Z', '2026-04-28T16:00:00Z'),
    ('tkt-07', 'AMPRI-260501-002', 'Request for visitor gate pass system update', 'Administrative', 'Low', 'Current visitor gate pass system does not capture visitor purpose correctly. Request adding a remarks field to the digital form.', 'H001', 'H001', 'Open', '2026-05-01T07:00:00Z', '2026-05-01T07:00:00Z', NULL),
    ('tkt-08', 'AMPRI-260420-001', 'Stationery requisition for Q2', 'Administrative', 'Low', 'Quarterly stationery requisition for all 6 divisions. Attached the consolidated list. Approval needed by May 15.', 'H001', 'H001', 'Closed', '2026-04-20T10:00:00Z', '2026-05-05T12:00:00Z', '2026-05-02T12:00:00Z'),
    ('tkt-09', 'AMPRI-260505-001', 'Leave encashment policy clarification', 'HRGrievance', 'Medium', 'Need clarification on leave encashment rules for project staff whose contracts were extended. Different interpretations from Finance and HR.', 'S003', 'H001', 'Open', '2026-05-05T12:00:00Z', '2026-05-05T12:00:00Z', NULL),
    ('tkt-10', 'AMPRI-260410-001', 'Increment not reflected in March salary', 'HRGrievance', 'High', 'My annual increment effective January 2026 was not reflected in the March 2026 salary slip. Request correction and arrears.', 'T004', 'H001', 'Resolved', '2026-04-10T14:00:00Z', '2026-04-20T09:00:00Z', '2026-04-20T09:00:00Z'),
    ('tkt-11', 'AMPRI-260506-001', 'Travel advance settlement for DRDO meeting', 'Finance', 'Medium', 'Need to settle travel advance of Rs. 25,000 taken for DRDO project review meeting in Delhi on April 20-22. Bills attached.', 'S040', 'H002', 'InProgress', '2026-05-06T11:00:00Z', '2026-05-07T09:00:00Z', NULL),
    ('tkt-12', 'AMPRI-260425-001', 'Equipment AMC payment renewal — SEM', 'Finance', 'Critical', 'AMC for Scanning Electron Microscope (E002, Zeiss) expired. Invoice received for renewal. Payment must be processed before May 15 to avoid service gap.', 'T002', 'H002', 'InProgress', '2026-04-25T09:00:00Z', '2026-05-03T16:00:00Z', NULL),
    ('tkt-13', 'AMPRI-260330-001', 'Project fund utilization certificate for OLP-2023-01', 'Finance', 'Medium', 'Utilization certificate for project OLP-2023-01 for FY 2025-26 needs CSIR-HQ submission by April 30. Funds utilized: Rs. 21,00,000.', 'S001', 'H002', 'Closed', '2026-03-30T08:00:00Z', '2026-04-25T10:00:00Z', '2026-04-15T10:00:00Z'),
    ('tkt-14', 'AMPRI-260507-001', 'Need argon gas cylinder for glovebox', 'LabResearch', 'High', 'Argon gas cylinder for glovebox in Lab-NST is empty. Thin film deposition work is blocked. Two cylinders needed — one for use, one as backup.', 'T002', 'S037', 'Open', '2026-05-07T08:00:00Z', '2026-05-07T08:00:00Z', NULL),
    ('tkt-15', 'AMPRI-260503-002', 'Chemical waste disposal — corrosion testing lab', 'LabResearch', 'Medium', 'Corrosion testing lab (E102) has accumulated ~15L of chemical waste from salt spray tests. Needs authorized disposal as per CSIR safety guidelines.', 'T004', 'S040', 'InProgress', '2026-05-03T14:00:00Z', '2026-05-05T11:00:00Z', NULL),
    ('tkt-16', 'AMPRI-260418-001', 'Request for deionized water plant maintenance', 'LabResearch', 'Low', 'DI water plant in Lab-B showing reduced output. RO membrane may need replacement. Last serviced December 2025.', 'S026', 'S037', 'Open', '2026-04-18T09:00:00Z', '2026-04-18T09:00:00Z', NULL),
    ('tkt-17', 'AMPRI-260502-002', 'Journal access expired — Acta Materialia', 'Library', 'High', 'Access to Acta Materialia journal through CSIR-NISTADS consortium appears to have expired. Multiple researchers unable to access recent articles.', 'S002', 'S001', 'InProgress', '2026-05-02T13:00:00Z', '2026-05-03T10:00:00Z', NULL),
    ('tkt-18', 'AMPRI-260506-002', 'Request to add books to library catalog', 'Library', 'Low', 'Please add the following 5 books to the CSIR-AMPRI library catalog: (list attached). Recommended by PhD supervisors for student reference.', 'S025', 'S001', 'Open', '2026-05-06T10:00:00Z', '2026-05-06T10:00:00Z', NULL),
    ('tkt-19', 'AMPRI-260504-002', 'Vehicle booking for field visit to Mandideep', 'Transport', 'Medium', 'Request official vehicle for field visit to industrial cluster in Mandideep on May 12. 4 staff members, full day trip.', 'S014', 'S012', 'Open', '2026-05-04T11:00:00Z', '2026-05-04T11:00:00Z', NULL),
    ('tkt-20', 'AMPRI-260408-001', 'Vehicle logbook discrepancy — April 2026', 'Transport', 'Low', 'Vehicle No. MP04-CA-1234 logbook shows 150km more than odometer reading for April. Request audit of fuel receipts.', 'H002', 'S012', 'Resolved', '2026-04-08T10:00:00Z', '2026-04-18T15:00:00Z', '2026-04-18T15:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('trs-01', 'tkt-01', 'S001', 'Acknowledged. I have contacted the HVAC maintenance contractor. They will inspect on May 3.', '2026-05-02T10:00:00Z'),
    ('trs-02', 'tkt-01', 'T001', 'Thank you. To clarify — the AC unit model is Blue Star 2TR split. The outdoor unit shows error code E3 (compressor overload). Sharing this for the technician.', '2026-05-02T14:00:00Z'),
    ('trs-03', 'tkt-06', 'S037', 'Priority approved. I have placed an order for 16 x 12V 42Ah SMF batteries. Expected delivery April 22.', '2026-04-16T10:00:00Z'),
    ('trs-04', 'tkt-06', 'S037', 'Batteries installed and tested. UPS runtime restored to ~45 minutes at full load. Closing this ticket.', '2026-04-28T16:00:00Z'),
    ('trs-05', 'tkt-10', 'H001', 'I have checked your records. The increment order was received from Director office on April 12. Arrears will be processed in April salary.', '2026-04-12T09:00:00Z'),
    ('trs-06', 'tkt-10', 'T004', 'Thank you. I have received the arrears in April salary. Please close the ticket.', '2026-04-20T09:00:00Z'),
    ('trs-07', 'tkt-12', 'H002', 'Invoice verified against AMC agreement. Payment processing initiated — expected to reflect by May 10.', '2026-05-03T16:00:00Z'),
    ('trs-08', 'tkt-04', 'S012', 'Called TA Instruments service. Engineer visit scheduled for May 5. Please ensure the instrument is powered down before the visit.', '2026-05-01T10:00:00Z'),
    ('trs-09', 'tkt-15', 'S040', 'Contacted authorized waste disposal agency (MPPCB-approved). Collection scheduled for May 10. Please segregate waste by type and label containers.', '2026-05-05T11:00:00Z'),
    ('trs-10', 'tkt-17', 'S001', 'I have raised this with CSIR-NISTADS consortium coordinator. Will update once I hear back.', '2026-05-03T10:00:00Z')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('tev-01', 'tkt-01', 'Created', 'T001', '{"token":"AMPRI-260501-001","category":"Infrastructure"}'::jsonb, '2026-05-01T09:00:00Z'),
    ('tev-02', 'tkt-01', 'Assigned', 'system', '{"assigned_to":"S001"}'::jsonb, '2026-05-01T09:00:00Z'),
    ('tev-03', 'tkt-01', 'StatusChanged', 'S001', '{"from":"Open","to":"InProgress"}'::jsonb, '2026-05-02T10:00:00Z'),
    ('tev-04', 'tkt-06', 'Created', 'S002', '{"token":"AMPRI-260415-001","category":"EquipmentIT"}'::jsonb, '2026-04-15T10:00:00Z'),
    ('tev-05', 'tkt-06', 'Assigned', 'system', '{"assigned_to":"S037"}'::jsonb, '2026-04-15T10:00:00Z'),
    ('tev-06', 'tkt-06', 'StatusChanged', 'S037', '{"from":"Open","to":"InProgress"}'::jsonb, '2026-04-16T10:00:00Z'),
    ('tev-07', 'tkt-06', 'Resolved', 'S037', '{"from":"InProgress","to":"Resolved"}'::jsonb, '2026-04-28T16:00:00Z'),
    ('tev-08', 'tkt-10', 'Created', 'T004', '{"token":"AMPRI-260410-001","category":"HRGrievance"}'::jsonb, '2026-04-10T14:00:00Z'),
    ('tev-09', 'tkt-10', 'Resolved', 'H001', '{"from":"Open","to":"Resolved"}'::jsonb, '2026-04-20T09:00:00Z'),
    ('tev-10', 'tkt-13', 'Created', 'S001', '{"token":"AMPRI-260330-001","category":"Finance"}'::jsonb, '2026-03-30T08:00:00Z'),
    ('tev-11', 'tkt-13', 'Closed', 'S001', '{"from":"Resolved","to":"Closed"}'::jsonb, '2026-04-25T10:00:00Z'),
    ('tev-12', 'tkt-20', 'Created', 'H002', '{"token":"AMPRI-260408-001","category":"Transport"}'::jsonb, '2026-04-08T10:00:00Z'),
    ('tev-13', 'tkt-20', 'Resolved', 'S012', '{"from":"Open","to":"Resolved"}'::jsonb, '2026-04-18T15:00:00Z')
ON CONFLICT (id) DO NOTHING;
