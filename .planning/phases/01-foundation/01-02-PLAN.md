...
```
  ...
  <acceptance_criteria>
    ...
    <criterion>grep -v '^#' supabase/migrations/20260507000000_committees_helpdesk.sql | grep -c "CREATE POLICY.*FOR SELECT TO authenticated" returns 11</criterion>
    ...
    <criterion>grep -c "AMRPI-" supabase/migrations/20260507000000_committees_helpdesk.sql returns 1</criterion>
  </acceptance_criteria>
