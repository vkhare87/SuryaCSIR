...
export const sectionSchemas = {
  ...
  section_i1: z.object({ items: z.array(z.record(z.string())).default([]) }),
  section_i2: z.object({ items: z.array(z.record(z.string())).default([]) }),
  section_i3: z.object({ items: z.array(z.record(z.string())).default([]) }),
  section_i4: z.object({ text: maxWords(150).default('') }),
  section_i5: z.object({ text: maxWords(100).default('') }),
  section_ii:  z.object({ items: z.array(z.record(z.string())).default([]) }),
  ...
  section_v_extension:   z.object({ items: z.array(z.record(z.string())).default([]) }),
  section_v_other:       z.object({ text: maxWords(150).default('') }),
  section_vi_national:   z.object({ items: z.array(z.record(z.string())).default([]) }),
  section_vi_international: z.object({ items: z.array(z.record(z.string())).default([]) }),
};
