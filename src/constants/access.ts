...
export const ACCESS_MAP = {
  ...
  '/partnerships':            ['Director', 'DivisionHead', 'Scientist', 'FinanceAdmin', 'HRAdmin', ...ADMINS] as Role[],
  '/rnd-monitor':             ['Director', 'DivisionHead', 'Scientist', 'FinanceAdmin', ...ADMINS] as Role[],
